...
# param3, key storepass: android. NOTE: this is not the key-pass, which accords with the 'kay-alias' and will be pomped when signing with the .keystore.
# param4, key alias: androiddebugkey. NOTE: the key' name.
